...
CORS(
    ...
    resources={
        r"/*": {
            "origins": [
                r"http://localhost:\d+",
                r"https://carbon-wise-navy\.vercel\.app",
                r"https://carbon-wise-git-main-shruti-bhundes-projects\.vercel\.app",
                r"https://carbon-wise-.*-shruti-bhundes-projects\.vercel\.app" # ◄ Matches any preview string!
            ]
        }
    },
